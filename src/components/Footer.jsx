...
function Footer() {
  return (
    <footer className="mt-32 font-pops bg-indigo-900 text-white shadow-xl">
      <div className="container mx-auto px-4 sm:px-8 lg:px-16 py-10 flex flex-col md:flex-row justify-between items-center md:items-start gap-12 text-center md:text-left">

        {/* Brand Info */}
        <div className="md:w-1/2">
          <h2 className="text-3xl sm:text-4xl font-bold">Janardan Insurance</h2>
          <p className="text-sm sm:text-base mt-3 text-purple-100 leading-relaxed max-w-md">
            Protecting what matters most — with trust and transparency.  
            Your reliable partner in life, health, and vehicle insurance.
          </p>
        </div>

        {/* Copyright */}
        <div className="md:w-1/2 text-sm sm:text-base text-purple-100 md:text-right border-t md:border-t-0 md:border-l border-purple-200/20 pt-6 md:pt-0 md:pl-10">
          <p>© {new Date().getFullYear()} Janardan Insurance</p>
          <p className="opacity-80">All rights reserved.</p>
        </div>
      </div>
